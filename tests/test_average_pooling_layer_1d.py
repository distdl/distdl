# Weird case #1
def test_average_pooling_layer_1d_1():
    ...
    layer = DistributedAvgPool1d(global_tensor_sizes, P_cart, kernel_size=[2], stride=[2])
...
# Weird case #2
def test_average_pooling_layer_1d_2():
    ...
    global_tensor_sizes = np.array([1, 1, 20])
...
# No comm needed
def test_average_pooling_layer_1d_3():
    ...
    global_tensor_sizes = np.array([1, 1, 12])
