def test_conv_2d_no_bias_co2_ci1_parallel():
...
def test_conv_2d_no_bias_co1_ci2_parallel():
    ...
    P_x = P_12.create_cartesian_topology_partition([1, 2, 2, 3])
    P_y = P_6.create_cartesian_topology_partition([1, 1, 2, 3])
    P_w = P_12.create_cartesian_topology_partition([1, 2, 2, 3])
...
def test_conv_2d_no_bias_co2_ci2_parallel():
    ...
    P_y = P_8.create_cartesian_topology_partition([1, 2, 2, 2])
...
def test_conv_2d_bias_only_co2_ci1_parallel():
...
def test_conv_2d_bias_only_co1_ci2_parallel():
...
def test_conv_2d_bias_only_co2_ci2_parallel():
