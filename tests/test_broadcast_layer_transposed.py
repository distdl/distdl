...
def test_broadcast_parallel_overlap_layer_transposed():
    ...
    PC_out = P_out.create_cartesian_topology_partition([3, 2, 2])

    layer = Broadcast(PC_in, PC_out, transpose_src=True)
...
def test_broadcast_parallel_barely_disjoint_layer_transposed():
...
def test_broadcast_parallel_completely_disjoint_layer_transposed():
...
def test_sum_reduce_parallel_layer_transposed_identity():
    ...
    layer = Broadcast(PC_in, PC_in, transpose_src=True)
...
def test_broadcast_sequential_transposed():
    ...
    layer = Broadcast(P_world, P_world, transpose_src=True)
