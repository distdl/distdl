# Weird case #1
def test_average_pooling_layer_2d_1():
    ...
    global_tensor_sizes = np.array([1, 1, 7, 9])

    layer = DistributedAvgPool2d(global_tensor_sizes, P_cart, kernel_size=[2, 2])
...
# Weird case #2
def test_average_pooling_layer_2d_2():
    ...
    global_tensor_sizes = np.array([1, 1, 18, 23])

    layer = DistributedAvgPool2d(global_tensor_sizes, P_cart, kernel_size=[4, 4])
...
# No comm needed
def test_average_pooling_layer_2d_3():
    ...
    global_tensor_sizes = np.array([1, 1, 8, 8])
