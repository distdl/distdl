...
def test_sum_reduce_parallel_overlap_single_src_layer():
    ...
    P_in = P_world.create_partition_inclusive(np.arange(0, 3))
    PC_in = P_in.create_cartesian_topology_partition([1, 1, 3])

    P_out = P_world.create_partition_inclusive(np.arange(2, 3))
    PC_out = P_out.create_cartesian_topology_partition([1])
...
def test_sum_reduce_parallel_barely_disjoint_single_src_layer():
    ...
    P_out = P_world.create_partition_inclusive(np.arange(3, 4))
    PC_out = P_out.create_cartesian_topology_partition([1])
...
def test_sum_reduce_parallel_completely_disjoint_single_src_layer():
    ...
    P_out = P_world.create_partition_inclusive(np.arange(4, 5))
    PC_out = P_out.create_cartesian_topology_partition([1])
